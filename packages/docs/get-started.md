...
```js
// 引入所有组件
import ToyElements from 'toy-elements'
// 引入样式
import 'toy-elements/dist/style.css'

import App from './App.vue'
// 全局使用
createApp(App).use(ToyElements).mount('#app')
```
...
toy-elements 提供了基于 ES Module 的开箱即用的 Tree Shaking 功能。
